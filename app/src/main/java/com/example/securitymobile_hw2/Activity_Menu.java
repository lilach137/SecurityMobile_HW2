package com.example.securitymobile_hw2;
    ...
    private void initViews() {
        this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (menu_EDT_id.getText().toString().length() != 9){
                    Toast.makeText(Activity_Menu.this, "please enter exactly 9 digits" , Toast.LENGTH_SHORT).show();
                    return;
                }
